...
describe EmbargoMailer do
    ...
    let(:work) { FactoryGirl.create(:generic_work_with_files, depositor: 'test@example.com', title: 'test', visibility: Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_EMBARGO, embargo_release_date: embargo_date) }
